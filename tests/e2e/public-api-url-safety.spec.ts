...
const PUBLIC_API_URL_CASES = [
  ...
  { label: 'destination intelligence validation state', path: '/api/destination-intel', allowedStatuses: [400] },
  { label: 'city info validation state', path: '/api/city-info', allowedStatuses: [400] },
  { label: 'weather validation state', path: '/api/weather', allowedStatuses: [400] },
  { label: 'holiday validation state', path: '/api/holidays', allowedStatuses: [400] },
  { label: 'same-currency exchange-rate conversion', path: '/api/exchange-rates?from=USD&to=USD&amount=100', allowedStatuses: [200] },
