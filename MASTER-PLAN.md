...
| Coverage depth | 9/10 | `npm run audit:coverage` now enforces a ratchet floor; current `lib` coverage is 99.44% lines and 99.17% branches. |
...
| Coverage ratchet current floor | DONE | `npm run audit:coverage` passes at 99.44% lines, 98.96% statements, 97.39% functions, 99.17% branches; branch floor is now 99.1%. |
...
| Stabilization Priority | Raise branch coverage from 84.07% toward 85% | DONE | Current branch coverage is 99.17% and the floor is 99.1%. |
...
| Backlog P1 | Raise branch coverage from 84.07% toward 85% | DONE | Current branch coverage is 99.17%. |
| Backlog P1 | Raise branch coverage from 85.08% toward 88% | DONE | Current branch coverage is 99.17% and the floor is 99.1%. |
| Backlog P1 | Raise branch coverage from 88.14% toward 90% | DONE | Current branch coverage is 99.17% and the floor is 99.1%. |
| Backlog P1 | Raise branch coverage from 90.04% toward 92% | DONE | Current branch coverage is 99.17%; the ratchet floor is now 99.1%. |
...
- [ ] Raise `lib` branch coverage toward 99.3%, focusing on remaining private/inaccessible hotels-catalog, price-cache, URL-safety, auth, and API/network error branches.
