...
| Coverage depth | 9/10 | `npm run audit:coverage` now enforces a ratchet floor; current `lib` coverage is 99.44% lines and 99.60% branches. |
...
| Coverage ratchet current floor | DONE | `npm run audit:coverage` passes at 99.44% lines, 99.06% statements, 97.39% functions, 99.60% branches; floors are now lines 99.4%, statements 99.0%, functions 97.3%, branches 99.6%. |
...
| Stabilization Priority | Raise branch coverage from 84.07% toward 85% | DONE | Current branch coverage is 99.60% and the floor is 99.6%. |
...
| Acceptance Criteria | `npm run audit:coverage` passes | DONE | Passed at 99.44% lines and 99.60% branches. |
...
| Backlog P1 | Raise branch coverage from 84.07% toward 85% | DONE | Current branch coverage is 99.60%. |
| Backlog P1 | Raise branch coverage from 85.08% toward 88% | DONE | Current branch coverage is 99.60% and the floor is 99.6%. |
| Backlog P1 | Raise branch coverage from 88.14% toward 90% | DONE | Current branch coverage is 99.60% and the floor is 99.6%. |
| Backlog P1 | Raise branch coverage from 90.04% toward 92% | DONE | Current branch coverage is 99.60%; the ratchet floor is now 99.6%. |
...
| Backlog P1 | Raise `lib` branch coverage toward 99.3% | DONE | Coverage reached 99.60% branches and the ratchet floor was raised above this target. |
| Backlog P1 | Raise `lib` branch coverage toward 99.5% | DONE | Coverage reached 99.60% branches and the ratchet floor was raised above this target. |
| Backlog P1 | Raise `lib` branch coverage toward 99.6% | DONE | Coverage reached 99.60% branches and the ratchet floor was raised to 99.6%. |
| Backlog P1 | Raise `lib` branch coverage toward 99.7% | PARTIAL | Remaining weak areas include private/inaccessible hotels-catalog, auth, hotel-popularity, agent-utils, Xotelo, ops-alerts, webhook URL, price-cache, and cheaper-dates branches. |
...
| --- | --- | --- |
| Raise `lib` branch coverage from 83.26% toward 84%, then keep ratcheting upward. | DONE | Real and verified by the current 99.60% branch coverage result. |
...
| Raise `lib` branch coverage beyond 99.1%, focusing on provider observability and catalog media edge branches. | DONE | Real and verified at 99.60% branches. |
| Raise `lib` branch coverage toward 99.3%, focusing on remaining private/inaccessible hotels-catalog, price-cache, URL-safety, auth, and API/network error branches. | DONE | Real and verified at 99.60% branches. |
| Raise `lib` branch coverage toward 99.5%, focusing on remaining private/inaccessible hotels-catalog, webhook URL, auth, hotel-popularity, URL-safety, and API/network error branches. | DONE | Real and verified at 99.60% branches. |
| Raise `lib` branch coverage toward 99.6%, focusing on remaining private/inaccessible hotels-catalog, auth, hotel-popularity, Xotelo, ops-alerts, cheaper-dates, Wikivoyage, Ticketmaster, and price-cache branches. | DONE | Real and verified at 99.60% branches; next honest target is 99.7%. |
...
| Raise `lib` branch coverage toward 99.7%, focusing on remaining private/inaccessible hotels-catalog, auth, hotel-popularity, agent-utils, Xotelo, ops-alerts, webhook URL, price-cache, and cheaper-dates branches. | PARTIAL | Next local engineering task after the current 99.60% branch coverage result. |
...
- [ ] Raise `lib` branch coverage toward 99.7%, focusing on remaining private/inaccessible hotels-catalog, auth, hotel-popularity, agent-utils, Xotelo, ops-alerts, webhook URL, price-cache, and cheaper-dates branches.
