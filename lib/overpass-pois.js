 ...
 * @param {number} [opts.timeoutMs=25000] - Request timeout in milliseconds
 * @returns {Promise<Array<{name: string, type: string, distance: string, icon: string, lat: number, lon: number, website?: string | null}>>}
 */
