...
/**
 * @typedef {object} ReadinessChecks
 * @property {{ available?: number, partnerConfigured?: boolean }} [providers]
 * @property {{ durable?: boolean, mode?: string }} [cache]
 * @property {{ deliveryConfigured?: boolean, deliveryStatus?: string, unsubscribeConfigured?: boolean, unsubscribeStatus?: string }} [alerts]
 * @property {{ providerConfigured?: boolean, status?: string }} [reviews]
 * @property {{ status?: string, push?: { configured?: boolean, status?: string } }} [pwa]
 */

/**
 * @typedef {object} PwaChecks
 * @property {string} [status]
 * @property {boolean} [installable]
 * @property {{ configured?: boolean, status?: string }} [push]
 */
...
/**
 * @param {{ checks?: ReadinessChecks, pwa?: PwaChecks, now?: Date }} [options]
 */
