...
const ACTIONS = [
  { icon: '🔍', label: 'Search Hotels', href: '/search', desc: 'Browse 63 hotels', color: 'bg-blue-50 hover:bg-blue-100 border-blue-200' },
  ...
  { icon: '🔥', label: "Today's Deals", href: '/deals', desc: 'Best prices now', color: 'bg-red-50 hover:bg-red-100 border-red-200' },
  ...
  { icon: '🤖', label: 'AI Agents', href: '/agents', desc: 'Smart scanning', color: 'bg-indigo-50 hover:bg-indigo-100 border-indigo-200' },
